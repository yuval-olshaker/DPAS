...
def ip_format(a, b, A, gamma=np.pi / 2, plot=False, color='b', linewidth=1,
    ...
    """
    M = A.shape[1]  # no. of elements along the x-axis
    N = A.shape[0]  # no. of elements along the y-axis
...
if __name__ == '__main__':
    ...
    b1 = 15e-3  # separation between elements along the y-axis in meters
    ...
    # A = dist(a, M, R, dist_type_x="Dolph-Chebyshev", mbar=False, alpha_x=0)
    # print 'array coefficients:', '\n', A.T
    ...
    # u, F, AF = pattern_u(array_ip, u_scan=0, u_min=-1, u_max=1, u_num=700, scale="dB", dB_limit=-40, factor="NF0", plot_type="rect", lattice=True)
